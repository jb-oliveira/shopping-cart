...
public class PlaceOrder {
    ...
    public PlaceOrder() {
        ...
        coupons.add(new Coupon("VALE20", 20.0));
        this.orders = new ArrayList<>();
    }

    public PlaceOrderOutputDTO execute(PlaceOrderImputDTO input) throws InvalidCpfException {
        ...
        if (input.getCoupon() != null) {
            Optional<Coupon> coupon = this.coupons.stream()
